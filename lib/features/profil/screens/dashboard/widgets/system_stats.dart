...
class SystemStats extends StatelessWidget {
  ...
  final bool dark;
  const SystemStats({super.key, required this.stats, required this.dark});
    ...
    return  Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SystemStatItem( 
              label: 'Total Produits', value:  stats.totalProducts.toString(), icon : Iconsax.box),
          SystemStatItem(
              label: 'Produits Stock Faible',
              value: stats.lowStockProducts.toString(), icon : Iconsax.warning_2),
          SystemStatItem(
          ...
          SystemStatItem(
              ...
              value: stats.ordersToday.toString(), icon : Iconsax.calendar),
          SystemStatItem(
              label: 'Commandes Ce Mois',
              value: stats.ordersThisMonth.toString(), icon : Iconsax.chart_2),
        ],
      ),
    );
  }
